...
const buildCourses = (instructorId: string) => [
  ...
  },
  {
    ...
    requirements: ['Solid fullstack basics', 'Intermediate JavaScript'],
    modules: [
      {
      ...
      },
      {
        ...
        lessons: [
          ...
          { title: 'Fullstack Capstone Quiz', type: 'quiz', duration: 10, videoUrl: '', order: 3, quiz: {
            passingScore: 60,
            questions: [
...
const buildJobs = (companyIds: string[], recruiterIds: string[]) => [
  ...
  { title: 'Fullstack Developer', description: 'Build modern web applications using React, Node.js and MongoDB for our fintech products.', responsibilities: ['Develop features across the full stack', 'Integrate with payment APIs', 'Ensure high code quality'], requirements: ['2+ years fullstack experience', 'Strong JavaScript and TypeScript', 'Payment integration experience a plus'], skills: ['MongoDB', 'Express', 'React', 'Node.js'], salaryMin: 65000, salaryMax: 95000, location: 'London, UK', jobType: 'Full-time', experienceLevel: 'Mid Level', remoteType: 'Remote', benefits: ['Flexible hours', 'Annual bonus', 'Training allowance'] },
